...
ggpairs(top.1 %>% select(tem, umi, onl), title = "Correlations of 1st response probabilities")
```
...
ggpairs(top.3 %>% select(tem, umi, onl), title = "Correlations of 3rd response probabilities", params =)
```
